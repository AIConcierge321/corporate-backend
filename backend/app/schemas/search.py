...
class FlightSearchRequest(BaseModel):
    ...
    max_stops: Optional[int] = Field(None, ge=0, le=2, description="Maximum number of stops (0=direct)")
    airlines: Optional[List[str]] = Field(None, description="Filter by airline codes")
    refundable_only: bool = Field(False, description="Only show refundable fares")
    max_duration_hours: Optional[int] = Field(None, description="Maximum flight duration in hours")
...
class HotelSearchRequest(BaseModel):
    ...
    min_stars: Optional[int] = Field(None, ge=1, le=5, description="Minimum star rating")
    max_stars: Optional[int] = Field(None, ge=1, le=5, description="Maximum star rating")
    chains: Optional[List[str]] = Field(None, description="Filter by hotel chain codes")
